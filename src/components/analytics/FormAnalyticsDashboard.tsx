                  ...
                  <div className="card p-6 space-y-6">
                    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Overview of Yes / No / N.A responses across sections
                        </p>
                      </div>
                      <button
                    ...
                    <div className="flex flex-wrap gap-2">
                      {filteredSectionStats.map((stat) => {
                        ...
                        return (
                          <label
                            key={stat.id}
                            className={`flex items-center gap-2 px-3 py-1 rounded-full border text-sm font-medium cursor-pointer transition-colors ${
                              selected
                    ...
                    <div className="overflow-x-auto rounded-2xl border border-gray-100 dark:border-gray-700">
                      <table className="min-w-full text-sm">
                        <thead className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800">
                          <tr>
                            <th className="text-left px-4 py-3">Section</th>
                            <th className="text-center px-4 py-3">Yes</th>
                            <th className="text-center px-4 py-3">No</th>
                            <th className="text-center px-4 py-3">N.A</th>
