              ...
              {location ? (
                ...
                >
                  ...
                  <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                    <button
                      ...
                      className={`flex-1 sm:flex-none inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-xs font-bold transition-all duration-200 ${darkMode
                ...
                >
                  ...
                  <button
                    ...
                    className={`mt-4 w-full inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-xs font-bold transition-all duration-200 ${darkMode
                    ...
                    {chassisNumbers.map((cn: { chassisNumber: string; partDescription: string }) => {
                      ...
                      return (
                        <button
                          ...
                          className={`p-4 rounded-xl text-left border-2 transition-all duration-200 group relative overflow-hidden ${answers['chassis_number'] === cn.chassisNumber
