  ...
  return (
    <div className="w-full px-6 md:px-8 py-6">
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl overflow-hidden">
        ...
        {/* Header */}
        <div className="p-6 md:p-8 border-b border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
        ...
        <div className="p-6 md:p-8 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex space-x-1 bg-gray-100 dark:bg-gray-900/50 p-1.5 rounded-xl w-fit shadow-inner">
              <button
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              <div className="relative flex-1 sm:min-w-[280px]">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2.5 text-sm border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm outline-none"
                />
              </div>
              <button
                onClick={exportToExcel}
                className="flex items-center justify-center px-5 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-xl font-bold text-sm transition-all active:scale-95 shadow-md hover:shadow-lg"
              >
                ...
                filteredLogs.map((log) => (
                  <div key={log._id} className="p-4 space-y-4 hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-primary-50/50 dark:bg-primary-900/10 p-2.5 rounded-xl border border-primary-100/50 dark:border-primary-900/20">
                        <p className="text-[9px] font-bold text-primary-600 dark:text-primary-400 uppercase mb-1 flex items-center gap-1">
                          <Clock size={10} /> Login
                        </p>
                        <p className="text-xs text-primary-900 dark:text-blue-200 font-medium">
                          {new Date(log.loginTime).toLocaleDateString()}
                        </p>
                        <p className="text-[10px] text-primary-500 dark:text-primary-400 font-bold">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      log.location.latitude ? (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center px-3 py-1.5 bg-gray-100 dark:bg-gray-800 text-primary-600 dark:text-primary-400 rounded-lg text-xs font-bold hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                        >
